...
var (
	...
	manyAddrsCount           = flag.Int("manyAddrsCount", 50, "the addrs count to use for scenarios which involve many addresses")
	manyAddrsSpace           = flag.Int("manyAddrsSpace", 100, "the index space to use for scenarios which involve many addresses")
	...
	manyAddrsSpentMixedCount = flag.Int("manyAddrsSpentMixedCount", 50, "the addrs count to use for scenarios which involve many unspent/spent addresses")
	manyAddrsSpentMixedSpace = flag.Int("manyAddrsSpentMixedSpace", 100, "the index space to use for scenarios which involve many unspent/spent addresses")
